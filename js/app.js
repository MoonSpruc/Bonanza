(() => {
    ...
    (() => {
        ...
        function isMenuEffect() {
            ...
            function menuEffect() {
                ...
                function menuEffectItem(menuLinks, effectSpeed) {
                    ...
                    const effectTop = `transform: translate3d(0px, -101%, 0px);`;
                    const effectBottom = `transform: translate3d(0px, 101%, 0px);`;
                    menuLinks.forEach((menuLink => {
                        menuLink.insertAdjacentHTML("beforeend", `\n                    <span style="transform: translate3d(0px,101%,0px);" class="hover">\n                        <span style="transform: translate3d(0px,-101%,0px);" class="hover__text">${menuLink.textContent}</span>\n                    </span>\n                `);
            ...
            console.log("Интересное меню есть");
        }
        ...
        if (document.querySelector("[data-datepicker]")) {
            ...
            modules_andModules.datepicker = picker;
        }
